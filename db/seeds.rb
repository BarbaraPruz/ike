u1 = User.create(:name => "Johnny Appleseed", :email => "johnny@domain.com", :password => "test")
...
latin1 = "<p>Lorem ipsum dolor sit amet, per dicunt regione scripserit ad, id ius quodsi appareat, unum erat legendos eos in. Duis animal ei vel. Vis debitis mandamus ut, dolorem fastidii at sit, unum vidit malis eu mei. Eam deserunt appellantur et, vis soluta placerat cu. Has ea corpora dissentiunt liberavisse, legere moderatius nec in, ne cum debitis adipiscing.</p>"
latin2 = "<p>Quaeque offendit ut qui. At posse vocent qui, vix numquam pericula petentium ad. Mea ad amet liberavisse. At vidit error percipitur pri, ius ei quod fugit concludaturque, ad duo detraxit efficiantur neglegentur. Ex pro quod animal conclusionemque, in mel facilisis intellegat temporibus, per ut nusquam indoctum. Usu ad affert virtute, deleniti posidonium ad mel.</p>"
latin3 = "<p>Est alii consequat constituam ne. Mel no diam invidunt interpretaris. Id mel atomorum voluptatum, scriptorem complectitur cu his. Errem quando postulant vel et. Sumo unum ius ei, unum platonem duo ea.</p>"
latin4 = "<p>Best Article Ever - Noster cotidieque cum an, scripta nostrum ius te, bonorum elaboraret nam eu. Sed tibique similique deterruisset ea. Te quo probo audire senserit, natum suavitate at vix, indoctum iudicabit vis ea. Pro ea probo posidonium percipitur, eos invenire maluisset ei. Dicta complectitur nam ex, nam no rationibus deterruisset. Te timeam oportere vel.<p>"
a1 = Article.create(
                :title => "Types of Succulents", :topic_id => s1.id,
...
a3 = Article.create(:title => "Herb Types", :topic_id => h1.id,
